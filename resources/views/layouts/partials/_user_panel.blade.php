    ...
    <div class="offcanvas-content pr-5 mr-n5">
        ...
        <div class="d-flex align-items-center mt-5">
            <div class="symbol symbol-100 mr-5">
                {{-- <div class="symbol-label" style="background-image:url('{{ asset('assets/images/userD.png') }}')"></div> --}}
...
{{--                    Application Developer--}}
                ...
                <div class="navi mt-2">
                    <a href="/{{env('ADMIN_URL')}}/users/{{auth()->user()->id}}/edit?profile=true" class="navi-item">
...
{{--            </a>--}}
        ...
        <div class="user-info">
            <div class="form-group d-flex">
                <h4 class="mr-1">Surname:  </h4>
                <h4>{{auth()->user()->last_name}}</h4>
            </div>
        </div>
        <div class="user-info">
            <div class="form-group d-flex">
                <h4 class="mr-1">Email: </h4>
