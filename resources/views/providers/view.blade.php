                ...
                <div class="filters">
                    <div class="row ">
                        <div style="display:flex; flex-wrap:wrap">
                            <div class="col-6  col-sm-3 col-lg-3 col-xl-2 mb-5">
                                <label>From</label>
                                <input id="from" type="date" class=" w-100 form-control datatable-filter" @if(isset($_GET['created'])) value="{{substr($_GET['created'],0,10)}}" @endif value="{{ isset($_GET['from']) ? $_GET['from'] : "" }}" data-live-search="true" data-filter="from_date_filter" onchange="DataTableHelper.updateFilter(this, 'string')">
                            </div>
                            ...
                            @foreach ($filters as $filterName => $filterLabel)
                                <div class="col-6 col-sm-3 col-lg-3  col-xl-2 mb-5 ">
                                    ...
                                    <input type="text" id="{{$filterName}}" class="w-100 form-control datatable-filter {{ $filterName }} " @if(isset($_GET[$filterName])) value="{{$_GET[$filterName]}}" @endif data-live-search="true" data-filter="{{ $filterName }}" placeholder="{{ $filterLabel }}" onchange="DataTableHelper.updateFilter(this, 'string')">
                                </div>
                            @endforeach
                        </div>
                    </div>
